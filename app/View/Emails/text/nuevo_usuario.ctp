<html>
<head>    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><style type="text/css">
	...
	<tbody>
		<tr>
			<td width="100%">
				...
				<table width="580" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth" bgcolor="#344c5e">
					<tbody>
						<!-- Spacing -->
	...
	<tbody>
		<tr>
			<td>
				...
				<table width="580" bgcolor="#3c8dbc" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
					<tbody>
						<tr>
							<td>
								<!-- logo -->

								<table width="280" cellpadding="0" cellspacing="0" border="0" align="left" class="devicewidth" bgcolor="#3c8dbc">
									<tbody>
										<tr>
											<td valign="middle" width="270" style="padding: 10px 0 10px 20px;" class="logo">
												<div class="imgpop">
													<div class="uploader_wrap" style="width: 100px; margin-top: 30px; opacity: 0;">
													...
													<p>
													<span style="text-align: center; font-family: Helvetica, arial, sans-serif; font-size: 23px; color: #FFFFFF; text-align:center;line-height: 5px;">TCU 593</span>
												</p>
								...
								<table width="280" cellpadding="0" cellspacing="0" border="0" align="right" class="devicewidth" bgcolor="#3c8dbc">
									<tbody>
										<tr>
	...
	<tbody>
		<tr>
			<td>
				...
				<table bgcolor="#e8edf0" width="580" align="center" cellspacing="0" cellpadding="0" border="0" class="devicewidth">
					<tbody>
						<tr>
									...
									<tbody>
										...
										<tr>
											<td style="font-family: Helvetica, arial, sans-serif; font-size: 18px; color: #333333; text-align:left;line-height: 20px;">
												<p>
													<span style="text-align: center;">Notificación:</span>
												</p>
											</td>
										</tr>
										<!-- end of title -->
													...
													<tbody>
														<tr>
															<td style="padding-left:18px; padding-right:18px;font-family:Helvetica, arial, sans-serif; text-align:center;  color:#ffffff; font-weight: 300;" width="auto" align="center" valign="middle" height="30">
																 <span style="color: #ffffff; font-weight: 300;"> <a style="color: #ffffff; text-align:center;text-decoration: none;" href="{{href}}" tabindex="-1">{{boton}}</a></span>
															</td>
														</tr>
													</tbody>
												</table>
					...
					<tbody>
						...
						<tr>
							<td align="center" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 10px;color: #999999">
								<p>
									<span style="color: rgb(255, 255, 255); font-size: 8pt;"><strong>TC-593</strong> Intercambio de Conocimientos con los Artesanos de Alajuela.</span>
								</p>
							</td>
						</tr>
						<!-- Spacing -->
